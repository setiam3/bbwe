<template>
  <div class="content_profile">
    <div class="profile-page-menu">
      ...
      <div :class="{'tools-item':true, active:checkRoute(['home1'])}"><router-link to="/"><img src="/images/icon/post-1.png" alt="" /></router-link></div>
      ...
      <div :class="{'tools-item':true, active:checkRoute(['home3'])}"><router-link to="/advertisement"><img src="/images/icon/post-7.png" alt="" /></router-link></div>
    </div>
