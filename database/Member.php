 ...
 * @property MemberArticles[] $memberArticles
 * @property MemberContacts[] $memberContacts
 * @property MemberContacts[] $memberContacts0
 * @property MemberJobs[] $memberJobs
 */
class Member extends \yii\db\ActiveRecord
{
    ...
    /**
     * Gets query for [[MemberArticles]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getMemberArticles()
    {
        return $this->hasMany(MemberArticles::className(), ['created_by' => 'id']);
    }

    /**
     * Gets query for [[MemberContacts]].
     *
     * @return \yii\db\ActiveQuery
     */
    ...
    /**
     * Gets query for [[MemberContacts0]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getMemberContacts0()
    {
        return $this->hasMany(MemberContacts::className(), ['created_by' => 'id']);
    }

    /**
     * Gets query for [[MemberJobs]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getMemberJobs()
    {
        return $this->hasMany(MemberJobs::className(), ['created_by' => 'id']);
    }
}
