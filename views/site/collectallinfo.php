<?php 
$this->title='collect all information';
use yii\web\View;
$js=<<<js
  $("header").remove();
...
<div class="invitation container bg-ornamen center mt-3 p-1" style="max-width: 80%">
	
		<div style="background: white" class="p-2">
  <h3 class="font-commando">Information We May Collect From You </h3>
  <br>
...
<div class="container">
  ...
  <div class="row mt-4">
    <div class="col-3">
      <a style="color:black" href="" ><img src="<?=$this->theme->baseUrl?>/images/icon-yourvoicemessage.png" class="img-fluid"><br>Your Navigation Across Our Website Sites (www.Blackbritishwomenexist.com)</a>
    </div>
    <div class="col-3">
