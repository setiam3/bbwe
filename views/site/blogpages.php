...
?>
<div class="row">
	<div class="col-md-7 center mb-5 mt-5">
	<img class="img-fluid" src="<?=$this->theme->baseUrl?>/images/logo.png" style="width: 70%;">
	</div>  
</div>
        ...
        <div class="form-group">
          <label class="sr-only" for="inlineFormInputGroup">Type One Keyword</label>
            <div class="input-group mb-2 gradation-bg rounded-pill">
              ...
              <input type="text" id="search-user" style="color: white;" class="form-control gradation-bg rounded-pill" id="inlineFormInputGroup" placeholder="Type One Keyword">
            </div>
        </div>
      </form>
			<ul class="list-down p-1">
				<?php 
